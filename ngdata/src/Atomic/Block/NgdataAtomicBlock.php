...
class NgdataAtomicBlock extends NgdataAtomic {
  ...
  public function getBlockChartByPrePostQuestionForPieChartColumn12($question_term = NULL, $meeting_nodes = array(), $chart_type = "pie", $color_box_palette = '', $bg_color_class = 'bg-0f69af') {
    ...
    $bottom_value .= '<div class="text-center width-pt-50 display-inline-block">';
      $bottom_value .= '<div class="display-inline-block">';
        $bottom_value .= $this->organism->getRaidoQuestionLegendHorizontalWithReferOther($question_term, $meeting_nodes, "Pre", "PRE-PROGRAM");
      $bottom_value .= '</div>';
    $bottom_value .= '</div>';
    $bottom_value .= '<div class="text-center width-pt-50 display-inline-block">';
      $bottom_value .= '<div class="display-inline-block">';
        $bottom_value .= $this->organism->getRaidoQuestionLegendHorizontalWithReferOther($question_term, $meeting_nodes, "Post", "POST-PROGRAM");
      $bottom_value .= '</div>';
    $bottom_value .= '</div>';
   ...
   *
   */
  public function getBlockHtmlTableByRadioQuestionMultipleByProgramBreakDownField($question_term = NULL, $meeting_nodes = array()) {
    $output = array();
    $table_body = NULL;

    $output = $this->organism->basicSection("htmlSnippt", "float-right margin-bottom-n-24 margin-right-16");
    $table_body = $this->organism->getHtmlTableByMultipleQuestionByProgramBreakDownField($question_term, $meeting_nodes);
